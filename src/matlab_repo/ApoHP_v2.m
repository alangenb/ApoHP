...
%
% ApoHP superimpose_data <newmutfile> <outdir> <installdir>
% --> loads in and formats user-provided mutation data from <newmutfile>
...
% --> maps user-provided mutation set to annotated GC basepair object
% --> computes APOBEC3A/3B character for each sample in user-defined cohort
% --> computes relative TpC/VpC hairpin mutation prevalence for each sample in user-defined cohort
