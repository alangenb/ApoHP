...
if nargin<3, error('Needs at least 3 input arguments: A,B,idx'); end
if isstruct(A) && isnumeric(B) && isstruct(idx), error('2nd+3rd argument positions are likely swapped.'); end
